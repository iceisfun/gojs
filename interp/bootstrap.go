...
func (i *Interpreter) bootstrap() {
	...
	i.asyncIteratorProto = NewObject(i.objectProto)
	i.asyncGeneratorProto = NewObject(i.asyncIteratorProto)
	i.dateProto = NewObject(i.objectProto)
	i.arrayBufferProto = NewObject(i.objectProto)
	i.sharedArrayBufferProto = NewObject(i.objectProto)
	i.dataViewProto = NewObject(i.objectProto)
	i.typedArrayProto = NewObject(i.objectProto)
