// Code generated from Unicode SpecialCasing.txt and DerivedCoreProperties.txt. DO NOT EDIT.

package interp

// specialLowerMap holds unconditional full lowercase mappings from SpecialCasing.txt
// (language-neutral). Final-sigma (U+03A3) is conditional and handled separately.
var specialLowerMap = map[rune][]rune{
	0x00DF: {0x00DF},
...
// specialUpperMap holds unconditional full uppercase mappings from SpecialCasing.txt.
var specialUpperMap = map[rune][]rune{
...
// casedRanges enumerates code points with the Unicode Cased property.
...
// caseIgnorableRanges enumerates code points with the Unicode Case_Ignorable property.
var caseIgnorableRanges = [][2]rune{
	{0x0027, 0x0027},
	{0x002E, 0x002E},
	{0x003A, 0x003A},
	{0x005E, 0x005E},
